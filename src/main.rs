...
fn main() {
    ...
    // This will handler writing to stdout for us using the WASI APIs
    println!("Hello world!");
    ...
    // For example, in wasmer, if you want to map the current directory to `/helloworld`,
    ...
    // Write the text to the file we created above
